    ...
    <div class="indexView">
        ...
        <div class="wrapper_3">
            <div class="wrapper_top">
                ...
                <span class="more" @click="more(2)">更多>></span>
            </div>
            <div class="line"></div>
            ...
            <div class="wrapper_top">
                ...
                <span class="more" @click="more(3)">更多>></span>
            </div>
            <div class="line"></div>
...
export default {
    ...
    methods: {
        ...
        more(value){
            if(value=='1'){
                this.$router.push('/baNoticeList/'+value+'/'+this.$router.state.system.userInfo.id);
            }else{
                this.$router.push('/newsList/'+value+'/'+this.$router.state.system.userInfo.id);
            }
        }
    }
}
