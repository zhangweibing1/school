<template>
    <div class="feedback">
      ...
      <div class="wrapper">
        <textarea name="fk" id="" v-model="content" cols="" rows="" placeholder="请输入您宝贵的意见或建议..."></textarea>
        <van-cell-group>
            <van-field label="姓名"
                v-model="$store.state.system.userInfo.userName"
                type="text" placeholder="请输入姓名" disabled left-icon="contact"
...
import { Rate,Checkbox, CheckboxGroup } from 'vant';
